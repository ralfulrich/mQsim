  ...
  if (det) {
    ...
    G4VSolid* crystalAssemblyS
      = new G4Box("CrystalAssembly", 
		  (wCell+2*crystalCase)/2, (wCell+2*crystalCase)/2, (heightCrystal+crystalCase)/2);
    
    G4LogicalVolume* crystalAssemblyLV
      = new G4LogicalVolume(crystalAssemblyS, metalCu, "CrystalAssembly"); 
    ...
    G4VSolid* sciS = new G4Box("SciBlock", wCell/2, wCell/2, heightCrystal/2);

    G4RotationMatrix* rotThis = new G4RotationMatrix();
    G4ThreeVector moveThis(0,0,crystalCase/2);
    G4SubtractionSolid* crystalcaseS = new G4SubtractionSolid("CrystalCase", crystalAssemblyS, sciS, rotThis, moveThis);
    
    G4LogicalVolume* crystalcaseLV = new G4LogicalVolume(crystalcaseS, air, "CrystalCase"); 
    ...
    G4OpticalSurface* crystal_opsurf = new G4OpticalSurface("crystal_opsurf", unified, polished, dielectric_dielectric);
    {
      const G4int NUM = 2;
    ...
    G4VSolid* cathodeS
      = new G4Tubs("Cathode", 0, radiusPMT, cathodeHeight/2, 0*degree, 360*degree);
    ...
    new G4PVPlacement(0, G4ThreeVector(0, 0, -distanceLayer/2 + heightCrystal + crystalCase + cathodeHeight/2),
		      cathodeLV, "Cathode", colLV, false, 0, checkOverlays);
